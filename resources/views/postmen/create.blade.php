...
<div class="content-box-large">
    <div class="panel-body content-box-header panel-heading">
        ...
        <div class="box-footer panel-title clearfix no-border">
            <h3>FORMULARIO PARA AGREGAR MENSAJERO</h3>
        </div>
    </div>
    <hr>
    <div class="row">
        ...
        <div class="col-lg-11">
            ...
            {!! Form::open(['route' => 'postmen.store', 'method'=>'POST', 'autocomplete'=>'off']) !!}
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        ...
                        {!! Form::select('zone_id',$zones, null, ['class'=>'form-control chosen', 'placeholder'=>'Seleccione una Zona...']) !!}
                    </div>
                </div>
            </div>
